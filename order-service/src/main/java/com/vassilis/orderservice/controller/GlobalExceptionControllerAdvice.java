...
import com.vassilis.orderservice.dto.RestApiError;
...
public class GlobalExceptionControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<RestApiError> handleException(Exception exception, HttpServletRequest request) {
    ...
    @ExceptionHandler
    public ResponseEntity<RestApiError> handleIllegalArgumentException(IllegalArgumentException exception,
    ...
    @ExceptionHandler
    public ResponseEntity<RestApiError> handleUnprocessableException(UnprocessableEntityException exception,
                                                                     HttpServletRequest request) {
